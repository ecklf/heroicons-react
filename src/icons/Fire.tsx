...
const Fire = ({ size = 24, ...props }: Props, svgRef: Ref<SVGSVGElement>) => {
  return (
    <svg
      viewBox="0 0 20 20"
      fill="currentColor"
    ...
    >
      <g clipPath="url(#prefix__clip0)">
        <path d="M14.243 15.243a6 6 0 01-8.486-8.486C5.757 9 6 11 9 12c0-2 1-8 2.5-9 1 2 1.571 2.586 2.742 3.757A5.981 5.981 0 0116 11a5.982 5.982 0 01-1.757 4.243z" />
